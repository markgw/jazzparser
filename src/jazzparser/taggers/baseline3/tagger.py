...
Tagging model 'baseline3' is another very simple tagging model that tags 
...
class Baseline3Model(TaggerModel):
    """
    ...
    def __init__(self, model_name, *args, **kwargs):
        super(Baseline3Model, self).__init__(model_name, *args, **kwargs)
...
class Baseline3Tagger(ModelTagger):
    """
