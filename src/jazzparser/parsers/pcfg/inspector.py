...
This is basically just copied from 
L{jazzparser.parsers.tagrank.inspector}.
...
class PcfgCellInspectorWindow(CellInspectorWindow):
...
class PcfgChartInspectorWindow(ChartInspectorWindow):
    CELL_INSPECTOR_IMPL = PcfgCellInspectorWindow

class PcfgChartInspectorThread(ChartInspectorThread):
    INSPECTOR_IMPL = PcfgChartInspectorWindow
